...
data work&y.&f.53;
     ...
     if RICE_YLD=. then YLD_QUAD=3;
        else if RICE_YLD=<400 then YLD_QUAD=1;
        else if RICE_YLD>400 then YLD_QUAD=2;
...
libname in&y.&f.10 xport '/trainee/jrhull/diss/ch2/c2data/c3_94_VL.xpt';
...
data work&y.&f.67;
     ...
     if V_RICE=. then V_LND_QD=3;
        else if V_RICE=<2502 then V_LND_QD=1;
        else if V_RICE>2502 then V_LND_QD=2;

     if V_1355=. then V_LAB_QD=3;
        else if V_1355=<597 then V_LAB_QD=1;
        else if V_1355>597 then V_LAB_QD=2;
...
data work&y.&f.73;
     ...
     if V_RICE=. then V_LND_Q2=3;
        else if V_RICE=<2503 then V_LND_Q2=1;
        else if V_RICE>2503 then V_LND_Q2=2;

     if V_1355=. then V_LAB_Q2=3;
        else if V_1355=<607 then V_LAB_Q2=1;
        else if V_1355>607 then V_LAB_Q2=2;
...
data work&y.&f.80 (keep=HHID94 Q1 AGE Q3);
     set in&y.&f.03.indiv&y (keep=HHID94 Q1 Q2 Q3 CODE2);
...
data work&y.&f.81 (keep=HHID94 NUMMEMS NUM_1355);
     set work&y.&f.80;
...
libname ot&y.&f.11 xport '/trainee/jrhull/diss/ch2/c2data/c2_94_RL.xpt';
