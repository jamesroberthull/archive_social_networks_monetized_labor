*********************************************************************
**     Program Name: /home/jrhull/diss/ch2/c2prog/c2_94_07.sas
...
%let f=94_7;   ** Allows for greater file portability **;
...
libname in&f.1 xport '/trainee/jrhull/diss/ch2/c2data/c2_94_02.xpt';
libname in&f.2 xport '/trainee/jrhull/diss/ch2/c2data/c2_94_03.xpt';

libname ot&f.1 xport '/trainee/jrhull/diss/ch2/c2data/c2_94_07.xpt';
...
proc import datafile='/afs/isis.unc.edu/home/j/r/jrhull/a_data/Village_Vars_94.txt' out=work&f.01 dbms=tab replace;
     getnames=yes;
     datarow=2;
run;
...
** Descriptive Statistics for All Village Variales **;
...
data work&f.06 (drop=V_NUM_T1 V_NUM_P1 V_NUM_F1 V_PRO_P1 V_PRO_F1
                     V_NUM_T4 V_NUM_P4 V_NUM_F4 V_PRO_P4 V_PRO_F4
                     V_NUM_T5 V_NUM_P5 V_NUM_F5 V_PRO_P5 V_PRO_F5
                     V_NUM_T6 V_NUM_P6 V_NUM_F6 V_PRO_P6 V_PRO_F6
                     V_NUM_T8 V_NUM_P8 V_NUM_F8 V_PRO_P8 V_PRO_F8
...
proc means data=work&f.06;
run;

proc univariate data=work&f.06;
run;
